...
export function PostCard(props: FormattedPost): JSX.Element {
  ...
  return (
    <div className="max-w-xs bg-cod-gray-100 hover:bg-white border border-cod-gray-200 rounded-sm shadow dark:bg-cod-gray-900 dark:hover:bg-cod-gray-800 dark:border-cod-gray-700 transition duration-300 ease-in-out">
